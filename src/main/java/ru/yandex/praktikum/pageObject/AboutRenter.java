...
public class AboutRenter {
    ...
    private final By metroState = By.className("select-search__input");
    ...
    public AboutRenter nameInput(String newName) {
        driver.findElement(name).sendKeys(newName);
        return this;
    }

    public AboutRenter surnameInput(String newSurname) {
        driver.findElement(surname).sendKeys(newSurname);
        return this;
    }

    public AboutRenter adressInput(String newAddress) {
        driver.findElement(address).sendKeys(newAddress);
        return this;
    }

    public AboutRenter chooseMetro(int stateNumber) {
        driver.findElement(metroState).click();
    ...
    public AboutRenter telephoneInput(String newTelephone) {
